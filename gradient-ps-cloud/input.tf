...
variable "machine_template_id_main" {
    ...
    default = "tpi7gqht" # tpi7gqht is pre-installed with nvidia and docker; docker is needed for cpu, whereas nvidia is needed for gpu, but using this template introduces very little bloat and speeds up node configuration
}
